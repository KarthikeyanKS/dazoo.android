...
import com.millicom.mitv.models.gson.TVChannelGuideJSON;
	...
	extends TVChannelGuideJSON
{
	...
	public ArrayList<TVBroadcast> getCurrentAndTwoUpcomingBroadcastsUsingSelectedDayAndHour(
			final int hour, 
			final TVDate tvDate) {
		return getCurrentAndUpcomingBroadcastsUsingSelectedDayAndHour(hour, tvDate, Consts.TV_GUIDE_NEXT_PROGRAMS_NUMBER);
	}
