...
import com.millicom.mitv.models.gson.deserializers.TVSearchResultEntityChannelDeserializer;
import com.millicom.mitv.models.gson.deserializers.TVSearchResultEntityProgramDeserializer;
import com.millicom.mitv.models.gson.deserializers.TVSearchResultEntitySeriesDeserializer;
...
public class TVSearchResultJSON implements GSONDataFieldValidation, JsonDeserializer<TVSearchResult> {
	...
	public TVSearchResult deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
		...
		JsonElement jsonElementEntity = jsonObject.get(Consts.JSON_KEY_SEARCH_RESULT_ITEM_ENTITY);
