	...
	extends SQLiteOpenHelper 
{
	private static final String	DATABASE_CREATE_QUERY	= 
			...
			Constants.NOTIFICATION_DB_COLUMN_PROGRAM_LOGO_PORTRAIT_SMALL + " TEXT, " +
			Constants.NOTIFICATION_DB_COLUMN_PROGRAM_LOGO_PORTRAIT_MEDIUM + " TEXT, " +
			Constants.NOTIFICATION_DB_COLUMN_PROGRAM_LOGO_PORTRAIT_LARGE + " TEXT, " +
			Constants.NOTIFICATION_DB_COLUMN_PROGRAM_LOGO_LANDSCAPE_SMALL + " TEXT, " +
			Constants.NOTIFICATION_DB_COLUMN_PROGRAM_LOGO_LANDSCAPE_MEDIUM + " TEXT, " +
			Constants.NOTIFICATION_DB_COLUMN_PROGRAM_LOGO_LANDSCAPE_LARGE + " TEXT, " +			
