	...
	extends AsyncTaskBase<Team[]>
{
	...
	public GetTeams(
			...
			boolean isRetry)
	{
		super(contentCallbackListener, activityCallbackListener, RequestIdentifierEnum.COMPETITION_TEAMS, Team[].class, HTTPRequestTypeEnum.HTTP_GET, buildURL(competitionID), false, isRetry);
	}
