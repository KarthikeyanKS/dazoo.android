	...
	extends AsyncTaskBase<Competition>
{
	...
	{
		super(contentCallbackListener, activityCallbackListener, RequestIdentifierEnum.COMPETITIONS_ALL, Competition.class, HTTPRequestTypeEnum.HTTP_GET, buildURL(competitionID));
	}
}
