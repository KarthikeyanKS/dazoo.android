...
public class TermsActivityOld extends SSActivity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.tab_tv_guide:
			// tab to home page
			Intent intentHome = new Intent(TermsActivityOld.this, HomeActivity.class);
		...
		case R.id.tab_activity:
			// tab to home page
			Intent intentActivity = new Intent(TermsActivityOld.this, ActivityActivity.class);
			startActivity(intentActivity);
			
			break;
		case R.id.tab_me:
			Intent intentMe = new Intent(TermsActivityOld.this, MyProfileActivity.class);
