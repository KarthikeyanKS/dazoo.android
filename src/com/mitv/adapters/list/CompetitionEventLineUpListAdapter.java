...
public class CompetitionEventLineUpListAdapter 
	extends BaseAdapter 
{
	private static final String TAG = CompetitionEventLineUpListAdapter.class.getName();
	...
	public CompetitionEventLineUpListAdapter(
	...
	public View getView(int position, View convertView, ViewGroup parent) 
	{
		...
		if (rowView == null) 
		{
			...
			viewHolder.highlight = (TextView) rowView.findViewById(R.id.row_competition_event_lineup_name);
			viewHolder.time = (TextView) rowView.findViewById(R.id.row_competition_event_lineup_time);
