...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
	...
	public void setViewPager(ViewPager view, int initialPosition) {
		...
		lastSelectedIndex = initialPosition;
	}
	...
	public class TabView extends TextView {
		...
		public TabView(Context context) {
			...
			if (light == null) 
			{
				light = Typeface.createFromAsset(getContext().getAssets(), "fonts/roboto_mitv_light.ttf");
			}
			setTypeface(light);
		}
	...
	{
		TabView tabView = (TabView) mTabLayout.getChildAt(lastSelectedIndex);
	...
	public void setStyleOnTabViewAtIndex(int index)
	{
		...
		if(tabView != null)
		{
			if (bold == null) 
			{
				bold = Typeface.createFromAsset(getContext().getAssets(), "fonts/roboto_mitv_bold.ttf");
			}
			tabView.setTypeface(bold);
		}
